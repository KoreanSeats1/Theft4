...
@property(nonatomic, readonly) UISwitch *constantReuse;
@property(nonatomic, readonly) UISwitch *frameStageTiming;
@property(nonatomic, readonly) UISwitch *displayPacing;
